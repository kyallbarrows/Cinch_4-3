...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public class AngleJoint : Joint
    {
        ...
        internal override void SolveVelocityConstraints(ref TimeStep step)
        {
            ...
            BodyA.AngularVelocity -= BodyA.InvI * Mathf.Sign(p) * Mathf.Min(Mathf.Abs(p), MaxImpulse);
            BodyB.AngularVelocity += BodyB.InvI * Mathf.Sign(p) * Mathf.Min(Mathf.Abs(p), MaxImpulse);
        }
