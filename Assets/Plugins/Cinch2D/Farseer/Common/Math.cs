...
namespace FarseerPhysics.Common
{
    ...
    /// <summary>
    /// A 2-by-2 Matrix4x4. Stored in column-major order.
    /// </summary>
    public struct Mat22
    {
        ...
        /// <summary>
        /// Construct this Matrix4x4 using columns.
        /// </summary>
        ...
        /// <summary>
        /// Construct this Matrix4x4 using scalars.
        /// </summary>
        ...
        /// <summary>
        /// Construct this Matrix4x4 using an angle. This Matrix4x4 becomes
        /// an orthonormal rotation Matrix4x4.
        /// </summary>
        ...
        /// <summary>
        /// Extract the angle from this Matrix4x4 (assumed to be
        /// a rotation Matrix4x4).
        /// </summary>
        /// <value></value>
        public float Angle
        {
            get { return Mathf.Atan2(Col1.y, Col1.x); }
        }
        ...
        /// <summary>
        /// Initialize this Matrix4x4 using columns.
        /// </summary>
        /// <param name="c1">The c1.</param>
        /// <param name="c2">The c2.</param>
        ...
        /// <summary>
        /// Initialize this Matrix4x4 using an angle. This Matrix4x4 becomes
        /// an orthonormal rotation Matrix4x4.
        /// </summary>
        /// <param name="angle">The angle.</param>
        ...
        /// <summary>
        /// Set this to the identity Matrix4x4.
        /// </summary>
        ...
        /// <summary>
        /// Set this Matrix4x4 to all zeros.
        /// </summary>
        public void SetZero()
        {
            Col1.x = 0.0f;
    ...
    /// <summary>
    /// A 3-by-3 Matrix4x4. Stored in column-major order.
    /// </summary>
    public struct Mat33
    {
    ...
    public struct Transform
    {
        ...
        /// <summary>
        /// Initialize using a position vector and a rotation Matrix4x4.
        /// </summary>
        ...
        /// <summary>
        /// Calculate the angle that the rotation Matrix4x4 represents.
        /// </summary>
        /// <value></value>
        public float Angle
        {
            get { return Mathf.Atan2(R.Col1.y, R.Col1.x); }
        }
    ...
    public struct Sweep
    {
        ...
        {
            float d = MathUtils.TwoPi * Mathf.Floor(A0 / MathUtils.TwoPi);
            A0 -= d;
            A -= d;
        }
    }
