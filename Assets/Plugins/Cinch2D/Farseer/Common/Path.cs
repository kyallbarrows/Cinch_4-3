...
namespace FarseerPhysics.Common
{
    ...
    public class Path
    {
        ...
        {
            for (int i = 0; i < ControlPoints.Count; i++)
                ControlPoints[i] = MathUtils.Multiply(ControlPoints[i], value);
        }
        ...
        public void Rotate(float value)
        {
            ...
            Quaternion rot = Quaternion.Euler(0, 0, value);
            for (int i = 0; i < ControlPoints.Count; i++)
                ControlPoints[i] = rot*ControlPoints[i];
        }
        ...
        public Vector2 GetPosition(float time)
        {
            ...
            if (Closed)
            {
                ...
                temp = MathUtils.CatmullRom(ControlPoints[p0], ControlPoints[p1], ControlPoints[p2], ControlPoints[p3], lt);
